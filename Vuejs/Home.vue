  ...
  <div>
      ...
      <div class="container align-items-start">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item" v-on:click.prevent="$parent.changeLang('en-us')" href="#">Lang En</a>
              <a class="dropdown-item" v-on:click.prevent="$parent.changeLang('de-ch')" href="#">Lang De</a>
            </div>
          </li>
        </ul>
        <div class="ex-create-project">
          ...
          <div v-if="userProjects.length === 0">
            <span style="color:#00c3fa;">C</span><span style="color:#01c3f5;">r</span><span style="color:#02c4ef;">e</span><span style="color:#02c4ea;">a</span><span style="color:#03c5e4;">t</span><span style="color:#04c5df;">e</span><span style="color:#05c6da;">&nbsp;</span><span style="color:#06c6d4;">y</span><span style="color:#06c7cf;">o</span><span style="color:#07c7c9;">u</span><span style="color:#08c7c4;">r</span><span style="color:#09c8bf;">&nbsp;</span><span style="color:#0ac8b9;">f</span><span style="color:#0ac9b4;">i</span><span style="color:#0bc9ae;">r</span><span style="color:#0ccaa9;">s</span><span style="color:#0dcaa4;">t</span><span style="color:#0eca9e;">&nbsp;</span><span style="color:#0ecb99;">p</span><span style="color:#0fcb93;">r</span><span style="color:#10cc8e;">o</span><span style="color:#11cc89;">j</span><span style="color:#12cd83;">e</span><span style="color:#12cd7e;">c</span><span style="color:#13ce78;">t</span><span style="color:#14ce73;">.</span>
    ...
    <b-modal ref="modalWizard" id="modalWizard" size="lg" hide-header hide-footer>
      ...
      <b-container>
        ...
        <project-form-wizard ref="projectFormWizard" :updateProjects="updateProjects" :allowPrevBtn="allowPrevBtn" :hidePrevBtn="hidePrevBtn"></project-form-wizard>
    </b-modal>
    ...
    <b-modal class="ex-delete-project-modal"
        ...
        <div slot="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" @click="hideCurrentProjectDeleteModal()">{{ $t('no') }}</button>
        </div>
    </b-modal>
  </div>
</template>
